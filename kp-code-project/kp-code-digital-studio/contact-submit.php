...
try {
    ...
    contact_form_respond(500, false, contact_form_error_message(), [], [], CONTACT_FORM_DEFAULT_REDIRECT);
}
...
if ($errors !== []) {
    contact_form_respond(422, false, 'Sprawdź formularz i popraw oznaczone pola.', $errors, $oldInput, $redirectPath);
}
...
try {
    ...
    $safeMessageHtml = nl2br(htmlspecialchars($sanitized['message'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'));
