const FleetSeed = {
  orders: [
    ...
    { id: 'FO-0975', client: 'AeroParts', route: 'Wrocław → Hamburg', status: 'delivered', eta: 'Dostarczono', priority: 'medium', updated: '2025-12-14T21:00:00Z' },
  ...
  vehicles: [
    { id: 'GD-5402N', type: 'Chłodnia', status: 'on-route', lastCheck: '2025-12-14', driver: 'K. Mazur' },
    { id: 'WA-9932K', type: 'Naczepa mega', status: 'available', lastCheck: '2025-12-10', driver: 'L. Kowal' },
    { id: 'PO-2201X', type: 'Plandeka', status: 'maintenance', lastCheck: '2025-12-12', driver: 'A. Lewandowska' },
    { id: 'KR-4412J', type: 'Furgon', status: 'available', lastCheck: '2025-12-15', driver: 'S. Wójcik' },
    { id: 'LU-7811L', type: 'Plandeka', status: 'on-route', lastCheck: '2025-12-13', driver: 'E. Piątek' }
  ],
  drivers: [
